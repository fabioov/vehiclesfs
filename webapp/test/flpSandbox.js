		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori App",
									"targetURL": "#Displayvehiclesfs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Displayvehiclesfs-display": {
								"semanticObject": "Displayvehiclesfs",
								"action": "display",
								"description": "Vehicles App",
								"title": "Fiori App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Display.vehiclesfs",
									"url": sap.ui.require.toUrl("Display/vehiclesfs")
								}
							}
						}
					}
